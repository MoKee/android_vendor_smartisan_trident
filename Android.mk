...
LOCAL_MODULE_OWNER := smartisan
LOCAL_SRC_FILES := proprietary/priv-app/a4wpservice/a4wpservice.apk
...
include $(CLEAR_VARS)
LOCAL_MODULE := wipowerservice
LOCAL_MODULE_OWNER := smartisan
LOCAL_SRC_FILES := proprietary/priv-app/wipowerservice/wipowerservice.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := com.qualcomm.qti.uceservice@2.0
LOCAL_MODULE_OWNER := smartisan
LOCAL_SRC_FILES_64 := proprietary/lib64/com.qualcomm.qti.uceservice@2.0.so
LOCAL_SRC_FILES_32 := proprietary/lib/com.qualcomm.qti.uceservice@2.0.so
LOCAL_MULTILIB := both
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
